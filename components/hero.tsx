    ...
    <section id="inicio" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="text-center lg:text-left space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground max-w-xl mx-auto lg:mx-0 leading-relaxed">
                La TPI vincula el cuerpo físico con los procesos emocionales, psíquicos y 
                sensoriales del ser humano, facilitando el camino hacia la armonía y el bienestar integral.
              </p>
            </div>
        ...
        <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 animate-bounce">
          <Link href="#sobre-mi" className="text-primary hover:text-primary/80 transition-colors">
