      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16 space-y-4">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Estoy aquí para acompañarte en tu proceso de sanación y autoconocimiento. 
            ...
            >
              <CardHeader className="text-center pb-4">
                <div className={`w-16 h-16 mx-auto mb-4 rounded-full flex items-center justify-center transition-transform group-hover:scale-110 ${
                  method.color === "primary" ? "bg-primary/10" : "bg-accent/20"
                }`}>
        ...
        <div className="mt-16 text-center">
          <div className="inline-flex items-center gap-2 px-6 py-3 bg-secondary/50 rounded-full">
            ...
            <span className="text-foreground">
              También puedes llamar al <strong>688 807 366</strong>
            </span>
          </div>
        </div>
      </div>
